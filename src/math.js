...
// Easing
module.exports.easeOutCubic = function(x, t, start_value, delta, duration) {
	t=t/duration-1;
	return delta*(t*t*t + 1) + start_value;
};
module.exports.easeOutCubic_Simple = function(t) {
	return module.exports.easeOutCubic(0, t, 0, 1, 1);
};
module.exports.easeInOutCubic_Simple = function(t) {
	return t<.5 ? 4*t*t*t : (t-1)*(2*t-2)*(2*t-2)+1
};

// Get curve data for bezier path along points
module.exports.bezCurve = function(ctx, points, tension, numOfSeg, close) {
	'use strict';
...
module.exports.quadrant = function(x, y) {
	if (x == 0 && y == 0) return 0;
	if (x > 0) { return y > 0 ? 1 : 2; }
	return y > 0 ? 4 : 3;
};
module.exports.angle_from_vertical = function(x, y) {
...
module.exports.format_number = function(x, n_decimals) {
